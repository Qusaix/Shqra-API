             ...
             <div class="card-content">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form class="form-horizontal m-t-sm" action="{{route('dashboard.products.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            ...
                                            <input value="{{(old('description'))}}" class="form-control input-lg" type="text" id="mega-username" name="description" placeholder="Enter The Description"  />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            ...
                                            <input value="{{(old('price'))}}" class="form-control input-lg" type="text" id="mega-username" name="price" placeholder="Enter The Price"  />
                                        </div>
                                    </div>
                                </div>
