				...
				<div class="row">
					<div class="banner-area-content">
						<div class="banner-area-head">
							<h1 class="pb30">Best App Landing Solution</h1>
							...
							<div class="row">
									...
									<div class="features-text-icon text-center">
										...
										<div class="features-text mt25">
											<div class="features-text-title pb10">
												<h3 class="deep-black">Responsive Design</h3>
											</div>
								...
								<div class="col-sm-4">
									<div class="features-text-icon text-center">
										...
										<div class="features-text mt25">
											<div class="features-text-title pb10">
												<h3 class="deep-black">Faster Performance</h3>
											</div>
											<div class="features-text-dec">
												<span>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span>
											</div>
								...
								<div class="col-sm-4">
									<div class="features-text-icon text-center">
										...
										<div class="features-text mt25">
											<div class="features-text-title pb10">
												<h3 class="deep-black">Easy To Customize</h3>
											</div>
											<div class="features-text-dec">
												<span>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span>
											</div>
				...
				<div class="row section-content">
					<div class="showcase-content">
						...
						<div class="showcase-slider">
							...
							<div class="showcase-img">
								<img src="assets/img/showcase/show-3.jpg" alt="img">
							</div>
							<div class="showcase-img">
								<img src="assets/img/showcase/show-4.jpg" alt="img">
							</div>
							<div class="showcase-img">
								<img src="assets/img/showcase/show-1.jpg" alt="img">
							</div>
				...
				<div class="row section-content">
					<div class="how-to-install-content">
						...
						<div class="install-play text-center">
							<a class="popup-with-zoom-anim" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><span class="orange-gred ti-control-forward"></span></a>
						</div>
						<!-- // install-play -->
					</div>
				</div><!-- /row -->
	...
	<!-- Start of our team section
		...
		<section id="our-team" class="our-team-section">
			<div class="container">
				<div class="row section-content">
					<div class="section-title text-center pb50">
						<span class="title-text pink text-uppercase">MEET OUR</span>
						<h1 class="title deep-black pb40">Dedicated Team</h1>
					</div>
					<!-- //section-title -->
						...
						<div class="row">
							<div class="col-md-3 col-sm-6">
								<div class="team-member-details">
									<div class="team-pic">
										<img src="assets/img/team/mem-1.jpg" alt="image">
									</div>
									<!-- //.team-pic -->
									...
									<div class="client-designation text-center pt25">
										<span class="name deep-black">Tonmoy Ahmed</span>
										<span class="designation">SR. Developer</span>
										<span class="client-details table-disply pt15">
											Duis aute irure dolor in reprehenderit in voluptate velit esse  eu fugiat nulla	
										</span>
									</div>
									<!-- //.client-designation -->
							...
							<div class="col-md-3 col-sm-6">
								<div class="team-member-details">
									<div class="team-pic">
										<img src="assets/img/team/mem-2.jpg" alt="image">
									</div>
									<!-- //.team-pic -->
									<div class="team-social ul-li text-center menu-bg-overlay">
										<ul class="team-social-list">
									...
									<!-- //.team-social -->
									<div class="client-designation text-center pt25">
										<span class="name deep-black">Rakibul Hasan</span>
										<span class="designation">SR. Developer</span>
										<span class="client-details table-disply pt15">
											Duis aute irure dolor in reprehenderit in voluptate velit esse  eu fugiat nulla	
										</span>
							...
							<div class="col-md-3 col-sm-6">
								<div class="team-member-details">
									<div class="team-pic">
										<img src="assets/img/team/mem-3.jpg" alt="image">
									</div>
									<!-- //.team-pic -->
									<div class="team-social ul-li text-center menu-bg-overlay">
										<ul class="team-social-list">
									...
									<!-- //.team-social -->
									<div class="client-designation text-center pt25">
										<span class="name deep-black">JI Mamun</span>
										<span class="designation">SR. Developer</span>
										<span class="client-details table-disply pt15">
											Duis aute irure dolor in reprehenderit in voluptate velit esse  eu fugiat nulla	
										</span>
							...
							<div class="col-md-3 col-sm-6">
								<div class="team-member-details">
									<div class="team-pic">
										<img src="assets/img/team/mem-4.jpg" alt="image">
									</div>
									<!-- //.team-pic -->
									<div class="team-social ul-li text-center menu-bg-overlay">
										<ul class="team-social-list">
									...
									<!-- //.team-social -->
									<div class="client-designation text-center pt25">
										<span class="name deep-black">Sujun Majhi</span>
										<span class="designation">SR. Developer</span>
										<span class="client-details table-disply pt15">
											Duis aute irure dolor in reprehenderit in voluptate velit esse  eu fugiat nulla	
										</span>
			...
			<div class="container">
				<div class="row section-content">
					<div class="blog-area-content">
						<div class="section-title text-center pb50">
							<span class="title-text pink text-uppercase">DON’T MISS OUR</span>
							<h1 class="title deep-black pb40">Latest Posts</h1>
						</div>
						<!-- //section-title -->

						<div class="blog-area-content-text">
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="blog-text-pic">
										...
										<div class="blog-time pt20">
											<span>25 APRIL 2017</span>
										</div><!-- //blog-time -->

										<div class="blog-link pt15 pb20">
											<h2 class="deep-black"><a href="#">Consectetur adipisicing elit sed do eiusmod tempor incid</a></h2>
										</div><!-- //blog-link -->

										<div class="blog-meta">
											<span class="meta-author"><a href="#!">5 comments - by Tonmoy Ahmed</a></span>
										</div>
									</div>
									<!-- //blog-text-pic -->
								</div>
						...
						<!-- //.blog-area-content-text -->
						<div class="load-more text-uppercase text-center">
							<a href="#">Load more</a>
						</div>
						<!-- //.load-more -->
					</div>
